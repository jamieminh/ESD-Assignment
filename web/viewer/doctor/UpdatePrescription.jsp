...
<%
    ...
    if (request.getAttribute("patient-list") == null) {
        response.sendRedirect("/UpdatePrescription");
    } else {
...
<div class="MainContent">   
    ...
    <% if (request.getAttribute("result") != null) {
            if (request.getAttribute("result").equals("success")) {
                ...
                out.print("</div>");
                out.print("<div>"+request.getAttribute("data")+"</div>");
    ...
    <div class="book-surgery-form">
        <form method="get" action="/UpdatePrescription">
            <div class="form-item">
        ...
        <div class="form-item">
            ...
            <div class="form-item">
                <lebel>Usage Frequency</lebel>
                <input type="input" name="Use-time" required/>
            </div>
