...
public class ViewPrescription extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
            ...
            PrescriptionDao prescriptionDao = new PrescriptionDao(con);
            ...
            if (request.getAttribute("prescriptions") == null) {
                prescriptions = prescriptionDao.getPrescriptionByCliId(client.getId());
...
//                    
                    ...
                    request.setAttribute("prescription", prescriptions);
                    request.getRequestDispatcher("/viewer/client/ViewPrescription.jsp").forward(request, response);
