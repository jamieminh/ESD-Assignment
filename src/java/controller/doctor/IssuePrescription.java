    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (request.getParameter("book-surgery") == null) {
                ...
                String IssueInformation = request.getParameter("issue-information");
                ...
                if (datePassed) {
                    ...
                    operationDao.addIssuePrescription(Integer.parseInt(empId), Integer.parseInt(patId),IssueInformation, surgDate, surgTime);
