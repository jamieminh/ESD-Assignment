 ...
 * @author WIN 10
 */
public class ForwardPatient extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (request.getParameter("book-surgery") == null) {
                ...
                request.getRequestDispatcher("/viewer/doctor/ForwardPatient.jsp").forward(request, response);
            } else {
                OperationDao operationDao = new OperationDao(con);
                String patId = request.getParameter("issue-patient");
                String DoctorID = request.getParameter("issue-information");
                String surgDate = request.getParameter("issue-date");
                String surgTime = request.getParameter("issue-time");
                ...
                if (datePassed) {
                    ...
                    operationDao.addForwardPatient(Integer.parseInt(DoctorID), Integer.parseInt(patId), surgDate, surgTime);
